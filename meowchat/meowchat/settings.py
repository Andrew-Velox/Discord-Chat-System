...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "account.authentication.CSRFExemptSessionAuthentication",  # Custom CSRF-exempt session auth
        "account.authenticate.JWTCookieAuthentication",  # Keep JWT as fallback
    ],
}
